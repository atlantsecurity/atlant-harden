...
| [DISA STIG — Microsoft Windows 11 (V2R7)](settings/disa-stig-microsoft-windows-11-v2r7.md) | 114 |
...
| [DISA STIG — Microsoft Office 365 ProPlus (V3R5)](settings/disa-stig-microsoft-office-365-proplus-v3r5.md) | 106 |

**Total: 579 settings.**

On each category page, every setting is tagged **Recommended** or **Maximum-only**.
